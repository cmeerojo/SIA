                    ...
                    <form action="{{ route('customers.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-4">
                            <div>
                                ...
                                <input id="dropoff_street" type="text" name="dropoff_street" value="{{ old('dropoff_street') }}"
                                       class="w-full border border-gray-300 rounded-lg px-4 py-3 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition"
                            ...
                            <div>
                                ...
                                <input id="dropoff_city" type="text" name="dropoff_city" value="{{ old('dropoff_city') }}"
                                       class="w-full border border-gray-300 rounded-lg px-4 py-3 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input id="dropoff_landmark" type="text" name="dropoff_landmark" value="{{ old('dropoff_landmark') }}"
                                       class="w-full border border-gray-300 rounded-lg px-4 py-3 shadow-sm focus:border-blue-500 focus:ring-blue-500 transition"
